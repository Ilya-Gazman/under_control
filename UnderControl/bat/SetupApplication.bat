...
:: Android packaging
set AND_CERT_NAME="StrategyOfBattle"
set AND_CERT_PASS=gazman666
set AND_CERT_FILE=cert\StrategyOfBattle.p12
...
set IOS_PROVISION=cert\StrategyOfBattle.mobileprovision
...
set APP_ID=air.StrategyOfBattle

:: Output packages
set DIST_PATH=dist
set DIST_NAME=StrategyOfBattle
